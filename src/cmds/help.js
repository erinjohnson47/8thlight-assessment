const menus = {
    main: `
    Welcome to the books app where you can search for books from the google books API and save books to your reading list. To search for a book enter "books search -k <search terms in quotes>" or "books search --keywords <search terms in quotes>". 
